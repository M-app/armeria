<?php 
  require_once('../public/conteo_id_categoria.php');
 ?>
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="../public/insertar_datos_categoria.php" method="POST">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nuevo ID categoria</label>
                          <div class="col-sm-9">
                            <input type="text" name="id_categoria" class="form-control" readonly="readonly"
                            <?php 
                              $con_cal = new conteo_id_categoria();
                              $new_id = $con_cal->get_conteo_id_categoria();
                              echo 'value="'.$new_id.'"';
                             ?>
                            >
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nombre Categoría</label>
                          <div class="col-sm-9">
