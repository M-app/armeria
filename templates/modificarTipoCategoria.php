                ...
                <div class="card-body">
                  ...
                  <form class="form-sample" action="../public/insertar_tipo_categoria.php" method="POST" >
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name="id_categoria">
                              <?php 
                                ...
                                $consulta = "SELECT nombre_categoria FROM categoriaproducto";
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nuevo ID Tipo Categoria</label>
                          <div class="col-sm-9">
                            <input type="text" name="id_tipo_categoria" class="form-control" readonly="readonly"
                             <?php 
                              $con_tip_cat = new conteo_id_tipo_categoria();
                              $new_id = $con_tip_cat->get_conteo_id_tipo_categoria();
                              echo 'value="'.$new_id.'"';
                             ?>
                            >
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nombre_tipo_arma" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
