                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nuevo ID Modelo</label>
                          <div class="col-sm-9">
                            <input type="text" name="id_modelo" class="form-control" readonly="readonly"
                            <?php 
                              $con_mod = new conteo_id_modelo();
                              $new_id = $con_mod->get_conteo_id_modelo();
                              echo 'value="'.$new_id.'"';
                             ?>
                            >
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nombre_modelo" class="form-control">
                          </div>
                        </div>
                      </div>
