<?php 
  require_once('../public/conteo_id_calibre.php');
 ?>
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="../public/insertar_datos_calibre.php" method="POST" >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">ID nuevo claibre</label>
                          <div class="col-sm-9">
                            <input type="text" name="id_calibre" class="form-control" readonly="readonly"
                            <?php 
                              $con_cal = new conteo_id_calibre();
                              $new_id = $con_cal->get_conteo_id_calibre();
                              echo 'value="'.$new_id.'"';
                             ?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nombre_calibre" class="form-control">
                          </div>
                        </div>
                      </div>
