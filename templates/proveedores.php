      ...
      <div class="main-panel">        
        <div class="content-wrapper">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Proveedores</h2>
                    <a type="button" href="modificarProveedor.php" class="btn btn-success">Nuevo</a>
                    <a type="button" href="modificarProveedor.php" class="btn btn-warning">Modificar</a>
                    <a type="button" href="modificarProveedor.php" class="btn btn-danger">Eliminar</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Todas los Proveedores</h4>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                         <?php 
                          ...
                          $consulta = "SELECT id_proveedor, nombre_proveedor, telefono_proveedor FROM proveedor";
                          ...
                          $fila = mysqli_fetch_array($resultado,MYSQLI_ASSOC);
                            ...
                            echo"<tr><td>".$fila['id_proveedor']."</td></p>";
                            echo"<td>".$fila['nombre_proveedor']."</p>";                   
                            echo "<td>".$fila['telefono_proveedor']."</td>";
                            echo"<td><a href='/modificar/proveedor/".$fila['id_proveedor']."'>Modificar</a><br>
                                  <a href='/eliminar/proveedor/".$fila['id_proveedor']."'>Eliminar</a></td></tr>";
                          }
                         ?>
                      </tbody>
                    </table>
